...
updated: "2026-09-17"
summary: "Per ridurre lo sfrido di lamiera bisogna prima misurarlo: sfrido (%) = (tonnellate acquistate − tonnellate spedite come prodotto) ÷ tonnellate acquistate × 100. I primi tre interventi non richiedono investimenti, solo misura e regolazione: adattare la larghezza del nastro a quella del coil, definire il rifilo per misura e correggere gioco lame e regolazione dell'avanzamento. Vengono poi il monitoraggio della tolleranza di spessore, coil più pesanti con carrello di carico e il layout nastro nidificato."
faq:
  - q: "Quanto si riduce lo sfrido adattando la larghezza del nastro a quella del coil?"
    a: "Tagliando nastri da 120 mm da un coil di 1.250 mm con 10 mm di rifilo totale, lo sfrido è di 50 mm, cioè il 4,0 %. Portando il nastro a 124 mm, dallo stesso coil escono sempre 10 nastri e lo sfrido scende a 10 mm, cioè lo 0,8 %: un quinto."
  - q: "La dimensione del coil incide sullo sfrido?"
    a: "Sì. Le perdite di inizio e fine linea sono per coil: se ogni cambio costa 8 metri, un coil da 3 tonnellate (circa 150 m) perde il 5,3 %, uno da 10 tonnellate (circa 500 m) l'1,6 %. Sulle linee dotate di saldatrice questa perdita quasi sparisce."
  - q: "Perché la tolleranza di spessore si comporta come sfrido?"
    a: "Acquistate a tonnellata e producete a metro: se ordinate 2 mm e ricevete 2,1 mm, lo stesso tonnellaggio rende il 5 % di metri in meno. Di solito non viene registrato come sfrido e appare solo come resa bassa; misurate periodicamente il materiale in ingresso e, se la tolleranza devia sempre in positivo, avrete un dato concreto da portare al fornitore."
  - q: "Quali interventi contro lo sfrido non richiedono investimenti?"
    a: "Adattare larghezza del nastro e del coil, definire il rifilo per misura e regolare gioco lame e avanzamento: servono solo misura e regolazione. Non c'è nulla da comprare: confrontando un mese di misura prima e uno dopo, il risultato si vede subito."
---
...
Eppure lo sfrido è una voce **che si paga ogni anno**: in uno stabilimento che lavora 10.000 tonnellate l'anno, ogni 1 % di sfrido sono 100 tonnellate comprate a prezzo di coil e vendute a prezzo di rottame. Questo articolo affronta da dove nasce e quali interventi funzionano davvero.
...
Non è sempre possibile: se la misura del cliente è fissa, la larghezza del nastro non è negoziabile. Ma la **larghezza del coil** di solito lo è. Chiedere al fornitore 1.210 mm (10 × 120 + 10) invece di 1.250 mm ottiene lo stesso risultato dall'altro lato.
...
I primi tre **non richiedono investimenti**: solo misura e regolazione. Misurate lo sfrido per un mese, applicate quei tre e confrontate con il mese successivo: non c'è nulla da comprare né da attendere, quindi il risultato si vede già alla misura seguente.

Provate le vostre misure nei [le nostre linee di taglio longitudinale](/dilme-hatlari), provate i [calcolatori](/hesaplayicilar) e [scriveteci](/iletisim) se volete parlare del dimensionamento della linea.
