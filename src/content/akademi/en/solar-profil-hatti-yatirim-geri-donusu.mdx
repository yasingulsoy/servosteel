---
title: "Solar Profile Line: How to Calculate the Payback"
...
updated: "2026-09-17"
summary: "A solar profile line makes sense once you have a continuous, predictable project pipeline; the threshold most often quoted is a multi-year portfolio of around 500 MW, and it drops if you do contract manufacturing or a local content rule applies. Payback is total investment divided by annual gain minus annual operating cost, where annual gain is annual output in tonnes times value added per tonne."
faq:
  - q: "How is the annual output of a solar profile line calculated?"
    a: "Annual tonnes = line speed × operating minutes × utilisation × weight per metre ÷ 1000. In the article's example, 15 m/min, a 4 kg/m profile, 2 × 8-hour shifts over 250 days and 60% utilisation give 8,640 tonnes a year."
  - q: "How much does utilisation change the result?"
    a: "At 75% instead of 60% utilisation, the same line and shifts produce 10,800 tonnes instead of 8,640 — 25% more output. Changeover time creates that gap, which is where a quick cassette-change arrangement pays for itself."
  - q: "How do I work out value added per tonne?"
    a: "Take the bought-in profile price and subtract coil cost, labour, energy and scrap. The figure varies significantly by region, steel price and profile type, so derive it from your own purchase invoices rather than using a generic number."
  - q: "What are Servosteel's forming rolls made of?"
    a: "They are produced from 4140 alloy steel and hardened to 58–60 HRC. Rolls that are not properly hardened cause dimensional drift and early replacement, which quietly wrecks the payback calculation."
---
...
### 1. Total investment
Not just the price of the line: freight, customs, installation and commissioning, site preparation (floor, power, compressed air), the **roll set** and any spare roll sets. We explain how the process works and what actually drives the cost in [what roll forming is](/akademi/roll-form-nedir). Roll forming lines are priced across a wide band depending on configuration; when you request a quote, pin down item by item what the scope includes.
...
You can review the line's components on our [solar mounting profile line](/roll-form-hatlari/solar-profil) page; we can also clarify together the first link of the line — the [decoiler](/makineler/rulo-acicilar) — and the roll set that defines the profile.
