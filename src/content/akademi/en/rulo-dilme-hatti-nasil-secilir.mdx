...
updated: "2026-09-17"
summary: "To choose a coil slitting line, first fix maximum coil weight, thickness range and target strip widths, then assess the knife unit, levelling, recoiler tension, automation and the manufacturer's service scope. The practical rule is to take one capacity tier above your heaviest coil, because frames and mandrels cannot be reinforced later. Light series run at 1,500–4,000 kg, heavy series at 6,000–15,000 kg."
faq:
  - q: "How should I size coil capacity for a slitting line?"
    a: "Take one tier above your heaviest coil: six tonnes for a 5-tonne coil, ten for an 8-tonne coil. The same 1,250 mm wide coil weighs about 13 tonnes at a 1,400 mm outer diameter and about 9 tonnes at 1,200 mm, so width alone does not define capacity."
  - q: "What happens if knife clearance is set wrong?"
    a: "Too little clearance shortens knife life and crushes the edge; too much produces burr and a torn edge. Precise, repeatable clearance adjustment matched to sheet thickness is the most critical feature of the line."
  - q: "Does a slitting line need a levelling unit?"
    a: "If your customers demand tight flatness, yes; if the strips feed a roll forming or tube line it is close to mandatory, because curved strip wanders off centre. Planning it from the start is cheaper and faster than retrofitting."
  - q: "How is slitting scrap calculated?"
    a: "Subtract edge trim from coil width, find how many strips fit and add the remainder to scrap. Cutting 120 mm strips from a 1,250 mm coil with 10 mm trim gives 10 strips, 40 mm left over and 50 mm total scrap, which is 4%."
---
...
If your strips will feed a [roll forming](/roll-form-hatlari) or tube line — the process is explained in [what roll forming is](/akademi/roll-form-nedir) — levelling is close to mandatory — curved strip wanders off centre in the forming line.
...
Use the [slitting yield calculator](/hesaplayicilar) with your own dimensions. Viewed in annual tonnage, a 2% difference in scrap comes to 200 tonnes a year on a line slitting 10,000 tonnes: steel bought at coil price and sold at scrap price.
