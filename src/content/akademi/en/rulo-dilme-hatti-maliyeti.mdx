...
updated: "2026-09-17"
summary: "Eight items set a slitting line's price, and coil capacity moves it hardest; sheet thickness and grade, width, strip count, levelling, automation, the recoiler and the control architecture follow. Freight, foundation and utilities, commissioning and critical spares are often missing from quotations. A realistic budget needs maximum coil weight, thickness range with material grade, and maximum width with target strip dimensions."
faq:
  - q: "Why is there no price list for a coil slitting line?"
    a: "It is not an off-the-shelf product: the same 1,250 mm slitting line can describe two machines that differ in price by a factor of two, depending on strip thickness and coil weight. Knowing what sets the price lets you read quotations correctly."
  - q: "Why does width raise the cost more than expected?"
    a: "The knife shaft deflects at the centre under cutting load; deflection grows with the cube of the span, while the shaft's resistance grows with the fourth power of its diameter. Buying a line wider than you need costs more than buying one heavier than you need."
  - q: "Which costs do quotations usually leave out?"
    a: "Freight and insurance, the concrete foundation with electrical supply and compressed air, commissioning and training, and a critical spare parts set. If they are not written in the quotation, they are simply not yet visible in your budget."
  - q: "How do I compare slitting line quotations fairly?"
    a: "Make six lines identical in every offer: maximum coil weight and outer diameter, thickness range and material grade, maximum width and minimum strip width, levelling and roll count, the thickness at which line speed was measured, and the scope of commissioning, training and spares."
---
...
The fact most often overlooked in the investment decision is this: **the line is paid for once, but scrap is paid for again every year the line runs.**

When the master coil width does not divide exactly by the strip width, the remainder becomes scrap. Cutting 120 mm strips from a 1,250 mm coil with 10 mm edge trim gives 10 strips and leaves 40 mm over; with the trim, scrap comes to 4 %. Across annual tonnage, a 2 % difference in scrap comes to 200 tonnes of steel a year on a line slitting 10,000 tonnes.
