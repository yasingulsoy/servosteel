...
updated: "2026-09-17"
summary: "Three things decide the servo feeder for a progressive die: systematic pitch error must stay below pilot pin clearance, the feeder's peak speed must fit inside the press window, and pilot release must be adjustable. To size it correctly, provide the part drawing, die pitch, number of stations and press strokes per minute."
faq:
  - q: "Which feeding error is most dangerous in a progressive die?"
    a: "Systematic error, which repeats in the same direction on every stroke. If the strip falls 0.05 mm short at every step, a ten-station die accumulates a 0.5 mm shift; once that exceeds pilot clearance, a pin breaks."
  - q: "Is a 60 mm pitch at 60 strokes per minute a slow feed?"
    a: "The average is only 3.6 m/min, but the feeder has to deliver each pitch in the fraction of a second when the press is open. Selection is based on that instantaneous peak speed, which is many times the average."
  - q: "Why must pilot release be adjustable?"
    a: "The feeder must open its grip at the moment the pilot pins pull the strip into position. Released too early, the strip can move; too late, pin and feeder work against each other. Pins enter at different press angles on different dies."
  - q: "What range do Servosteel servo feeders cover?"
    a: "0.4–4.0 mm thickness and widths up to 1,600 mm, with 35 m/min free feeding speed and 2 × Ø85 mm feed rollers. The feeder stores 250 recipes, and pilot pin release is standard."
---
