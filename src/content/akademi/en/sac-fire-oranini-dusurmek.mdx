...
updated: "2026-09-17"
summary: "Cutting sheet scrap starts with measuring it: scrap rate is tonnes purchased minus tonnes shipped as product, divided by tonnes purchased. The first three steps need no investment: match strip width to coil width (the highest-impact one), set edge trim by measurement, and correct knife clearance and feed setup. Tracking thickness tolerance, running heavier coils and nesting blanks come next."
faq:
  - q: "How much can matching strip width to coil width reduce scrap?"
    a: "Cutting 120 mm strips from a 1,250 mm coil with 10 mm trim leaves 50 mm total scrap, or 4.0%. Widening the strip to 124 mm still gives 10 strips from the same coil and cuts scrap to 10 mm, or 0.8%."
  - q: "Does coil size affect scrap?"
    a: "Yes. Start and end losses occur per coil: with 8 metres lost per change, a 3-tonne coil of roughly 150 m loses 5.3%, while a 10-tonne coil of roughly 500 m loses 1.6%. On lines with a welder the loss is nearly eliminated."
  - q: "Why does thickness tolerance behave like scrap?"
    a: "You buy by the tonne and produce by the metre, so material ordered at 2 mm but delivered at 2.1 mm yields 5% fewer metres from the same tonnage. It is rarely recorded as scrap; measuring incoming material gives you data to take to the supplier."
  - q: "Which scrap measures require no investment?"
    a: "Matching strip and coil width, setting edge trim by measurement, and getting knife clearance and feed setup right need only measurement and adjustment. Nothing has to be bought, so comparing one month of scrap measurement before and one after shows the result directly."
---
...
Yet scrap is a cost **paid again every year**: in a plant processing 10,000 tonnes a year, every 1% of scrap is 100 tonnes bought at coil price and sold at scrap price. This article covers where it comes from and which interventions genuinely work.
...
This is not always possible — if the customer's dimension is fixed, strip width is not negotiable. But **coil width** usually is. Asking your supplier for 1,210 mm (10 × 120 + 10) instead of 1,250 mm achieves the same result from the other direction.
...
The first three **require no investment** — only measurement and adjustment. Measure your scrap rate for one month, apply those three and compare the following month: nothing has to be bought or delivered, so the result shows up in the very next measurement.
