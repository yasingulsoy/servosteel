...
updated: "2026-09-17"
summary: "Der erste Schritt zu einer niedrigeren Verschnittquote ist die Messung: Verschnittquote (%) = (gekaufte Tonnen − als Produkt gelieferte Tonnen) ÷ gekaufte Tonnen × 100. Anfangen sollten Sie mit drei Maßnahmen ohne Investition: Streifen- und Coilbreite abstimmen, Besäumung per Messung festlegen sowie Messerspalt und Vorschub einstellen. Mit mehr Aufwand verbunden sind die Überwachung der Dickentoleranz, schwerere Coils mit Ladewagen und ein verschachteltes Bandlayout."
faq:
  - q: "Wie viel Verschnitt spart die Abstimmung von Streifen- und Coilbreite?"
    a: "Schneiden Sie 120-mm-Streifen aus einem 1.250-mm-Coil mit 10 mm Gesamtbesäumung, entstehen 50 mm Verschnitt, also 4,0 %. Bei 124 mm Streifenbreite ergeben sich aus demselben Coil ebenfalls 10 Streifen, der Verschnitt fällt aber auf 10 mm oder 0,8 %, also auf ein Fünftel."
  - q: "Beeinflusst die Coilgröße den Verschnitt?"
    a: "Ja. Verluste am Linienanfang und -ende fallen je Coil an: Kostet jeder Coilwechsel 8 Meter, verliert ein 3-Tonnen-Coil (rund 150 m) 5,3 %, ein 10-Tonnen-Coil (rund 500 m) nur 1,6 %. An Linien mit Schweißmaschine entfällt dieser Verlust nahezu."
  - q: "Warum wirkt die Dickentoleranz wie Verschnitt?"
    a: "Sie kaufen nach Tonnen ein und produzieren nach Metern. Bestellen Sie 2 mm und erhalten 2,1 mm, ergibt dieselbe Tonnage 5 % weniger Meter; das wird meist nicht als Verschnitt erfasst, sondern erscheint nur als schwache Ausbeute. Wer eingehendes Material regelmäßig misst, hat bei durchgängiger Abweichung nach oben belastbare Daten für das Gespräch mit dem Lieferanten."
  - q: "Welche Maßnahmen gegen Verschnitt erfordern keine Investition?"
    a: "Streifen- und Coilbreite abstimmen, die Besäumung per Messung festlegen sowie Messerspalt und Vorschub einstellen; dafür genügen Messung und Einstellung. Da nichts gekauft werden muss, zeigt der Vergleich je eines Messmonats vor und nach der Umsetzung das Ergebnis direkt."
---
...
Dabei ist Verschnitt ein Posten, der **jedes Jahr neu anfällt**: In einem Betrieb mit 10.000 t Jahresdurchsatz ist jedes Prozent Verschnitt 100 t Material, zum Coilpreis gekauft und zum Schrottpreis verkauft. Dieser Beitrag behandelt, woher er kommt und welche Maßnahmen tatsächlich wirken.
...
Das ist nicht immer möglich — steht das Kundenmaß fest, ist die Streifenbreite nicht verhandelbar. Die **Coilbreite** ist es meist schon. Beim Lieferanten 1.210 mm (10 × 120 + 10) statt 1.250 mm zu bestellen, erreicht dasselbe von der anderen Seite.
...
Die ersten drei **erfordern keine Investition** — nur Messung und Einstellung. Messen Sie Ihre Verschnittquote einen Monat lang, setzen Sie diese drei um und vergleichen Sie mit dem Folgemonat: Da nichts gekauft oder geliefert werden muss, zeigt sich das Ergebnis schon in der nächsten Messung.

Probieren Sie Ihre Maße in den [unseren Längsteilanlagen](/dilme-hatlari) und in den [Rechnern](/hesaplayicilar), und [schreiben Sie uns](/iletisim), wenn Sie über die Anlagenauslegung sprechen möchten.
