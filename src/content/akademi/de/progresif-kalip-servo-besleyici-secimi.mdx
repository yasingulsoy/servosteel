...
updated: "2026-09-17"
summary: "Drei Dinge entscheiden die Wahl des Servovorschubs am Folgeverbundwerkzeug: Der systematische Fehler muss unter dem Pilotspiel bleiben, die Spitzengeschwindigkeit muss das Pressenfenster abdecken, und die Pilotfreigabe muss einstellbar sein. Für die richtige Auslegung halten Sie Teilezeichnung, Schrittmaß, Stationszahl und Pressenhübe pro Minute bereit."
faq:
  - q: "Welcher Vorschubfehler ist im Folgeverbundwerkzeug am gefährlichsten?"
    a: "Der systematische Fehler, der bei jedem Hub in dieselbe Richtung abweicht. Bleibt das Band bei jedem Schritt 0,05 mm zurück, sind das bei einem Zehn-Stationen-Werkzeug 0,5 mm Gesamtverschiebung. Übersteigt der systematische Fehler das Pilotspiel, bricht ein Stift."
  - q: "Sind 60 mm Schritt bei 60 Hüben/min ein langsamer Vorschub?"
    a: "Nur auf den ersten Blick. Im Mittel ergeben sich lediglich 3,6 m/min, doch der Vorschub muss die 60 mm in dem Fenster liefern, in dem die Presse offen ist, und das ist ein Bruchteil einer Sekunde. Die erforderliche momentane Spitzengeschwindigkeit liegt um ein Vielfaches darüber und muss das Pressenfenster abdecken."
  - q: "Warum muss die Pilotfreigabe einstellbar sein?"
    a: "Der Vorschub muss die Anpressung genau dann öffnen, wenn die Pilotstifte das Band in Position ziehen. Zu frühe Freigabe lässt das Band frei, zu späte lässt Stift und Vorschub gegeneinander arbeiten. Da die Stifte bei verschiedenen Werkzeugen bei unterschiedlichen Pressenwinkeln eintreten, muss der Freigabezeitpunkt einstellbar sein."
  - q: "Welchen Bereich decken Servosteel-Servovorschübe ab?"
    a: "Servosteel-Servovorschübe arbeiten mit 0,4 – 4,0 mm Dicke und Breiten bis 1.600 mm, bei einer freien Vorschubgeschwindigkeit von 35 m/min. Die Vorschubrollen sind 2 × Ø85 mm, der Speicher fasst 250 Rezepte, und die Pilotfreigabe ist serienmäßig."
---
