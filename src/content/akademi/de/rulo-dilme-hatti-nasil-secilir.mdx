...
updated: "2026-09-17"
summary: "Für die Auswahl einer Spaltanlage legen Sie zuerst maximales Coilgewicht, Dickenbereich und Zielstreifenbreiten fest und bewerten dann Messereinheit, Richteinheit, Aufwickelspannung, Automatisierung sowie Hersteller und Service. Praktische Regel: eine Stufe über Ihrem schwersten Coil wählen, denn Rahmen und Dorn lassen sich nachträglich nicht verstärken. Leichte Baureihen laufen im Bereich 1.500–4.000 kg, schwere im Bereich 6.000–15.000 kg."
faq:
  - q: "Wie lege ich die Bundkapazität einer Spaltanlage aus?"
    a: "Eine Stufe über Ihrem schwersten Coil: sechs Tonnen für ein 5-Tonnen-Coil, zehn für ein 8-Tonnen-Coil. Dasselbe 1.250 mm breite Coil wiegt bei 1.400 mm Außendurchmesser rund 13 Tonnen, bei 1.200 mm rund 9 Tonnen; die Breite allein definiert die Kapazität also nicht."
  - q: "Was passiert bei falsch eingestelltem Messerspalt?"
    a: "Der Messerspalt wird als Prozentsatz der Blechdicke eingestellt. Zu wenig Spalt verkürzt die Messerstandzeit und quetscht die Kante, zu viel erzeugt Grat und ausgerissene Kanten. Deshalb ist die präzise und wiederholgenaue Spalteinstellung das kritischste Merkmal der Anlage."
  - q: "Braucht eine Spaltanlage eine Richteinheit?"
    a: "Wenn Ihre Kunden enge Planheit verlangen, ja. Gehen die Streifen in eine Rollformanlage oder Rohranlage, ist Richten nahezu Pflicht, denn gekrümmtes Band läuft in der Umformlinie aus der Mitte. Die Richteinheit von Anfang an einzuplanen, ist günstiger und schneller als Nachrüsten."
  - q: "Wie wird der Verschnitt beim Spalten berechnet?"
    a: "Ziehen Sie den Besäumschnitt von der Coilbreite ab, ermitteln Sie, wie viele Streifen hineinpassen, und rechnen Sie den Rest zum Verschnitt. 120-mm-Streifen aus einem 1.250-mm-Coil mit 10 mm Besäumschnitt ergeben 10 Streifen und 40 mm Rest; mit dem Besäumschnitt sind das 50 mm Verschnitt, also 4 %."
---
...
Gehen Ihre Streifen in eine [Rollformanlage](/roll-form-hatlari) oder Rohranlage, ist Richten nahezu Pflicht — gekrümmtes Band läuft in der Umformlinie aus der Mitte.
...
Nutzen Sie den [Spaltausbeute-Rechner](/hesaplayicilar) mit Ihren eigenen Maßen. Auf die Jahrestonnage gerechnet macht ein Unterschied von 2 % Verschnitt bei einer Spaltanlage mit 10.000 t Jahresdurchsatz 200 t aus: Stahl, zum Coilpreis gekauft und zum Schrottpreis verkauft.
