# Hedef Firmalar — Bölge Taraması: Batı ve Kuzey Avrupa

**Tarih:** 2026-09-21
**Doğrulanmış firma sayısı:** 23
**Yöntem:** Web search in local languages (FR, DE, NL, EN) + website verification for manufacturing capability
...
| Hoffmann Trapezbleche | Almanya | Çatı ve Cephe Paneli | https://www.trapezbleche.com/ | https://www.trapezbleche.com/ | Trapezbleche, Wellbleche; Niedersachsen; 40+ yıl | info@trapezbleche.com |
...
- **Vent-tillverkarna AB** — otomatik doğrulamada elendi (2026-09-21): e-ticaret sitesi, üretim izi yok

- **Stago (Hollanda)**: Kablo yönetim sistemleri üretim tesisi Hoorn'da olmasına rağmen, websitesi erişilemedi; doğrulama mümkün değildi
- **Akman Solutions (Hollanda)**: Kablo yönetim sistemi üretim tesisi konumu açıklanmadı; sadece Vlaardingen ofisi adresinde bulundu
- **Legrand (Hollanda)**: Çok büyük uluslararası grup (dışlama kriteri); belki kapasiteye ilişkin teklif içeriyor olabilir
- **Niedax (Hollanda)**: Çok büyük Alman grubu (dışlama kriteri)
- **Metalsteel, Jan Nowak, Lager und Werkstatt**: Dağıtıcı/perakendeci olarak çalışıyor; üretim tesisi yok
- **Toles Moins Cheres (Fransa)**: Distribütör olarak gösterilmiş; kendi üretim tesisinin olmadığı açıklanmadı
- **Airisol (Fransa)**: "Fabricant, Transformateur, Distributeur" olarak tanımlanmış ancak Kingspan ve Unilin gibi üçüncü taraf tedarikçilere bağımlı görülüyor; doğru üretim durumu belirsiz
- **DUWIC (Fransa)**: SSL hatası nedeniyle erişilemedi; doğrulama başarısız
- **Europlast (Almanya)**: Sentetik kasa üreticisi; metal ürün üretmiyor
- **Hoesch (Almanya)**: Banyo ürünleri (banyolar, duş tepsileri); metal inşaat ürünü değil
- **Lindner Group (Avusturya)**: Çok büyük uluslararası grup (dışlama kriteri); 8.000 çalışan, 1,3 milyar €
- **C+P Christmann und Pfeiffer (Almanya)**: Website erişilemedi; doğrulama başarısız
- **Ractem (Almanya)**: Website erişilemedi; doğrulama başarısız
- **Jan Nowak, GD Vent, Trapezblech Hoffmann**: Website adreslelemesi başarısız; DNS hatası
- **Steelform UK, Metalflex Plus**: Geçersiz domain veya erişilemez
